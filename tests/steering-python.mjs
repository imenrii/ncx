...
import { LIMITS } from '../web/src/steering/model.ts';
...
try {
  ...
  Object.assign(globalThis, {
    ...
    ncx_move_probe: async (_target, position) => {
      ...
      return JSON.stringify({indices,x:2,y:3,value:0});
    }, ncx_units: JSON.stringify(UNIT_FAMILIES),
    ncx_limits: JSON.stringify({ ...LIMITS, readBytes: 1024 * 1024, publishedBytes: 4 * 1024 * 1024, computeBytes: 8 * 1024 * 1024, blockBytes: 24, graphTasks: 10000, names: 100, history: 100, outputChars: 65536 }),
  });
